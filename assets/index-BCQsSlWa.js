(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}})();function C(t){const s=document.getElementById(t);if(!s)return;const n=s.getContext("2d");let i=s.width=window.innerWidth,e=s.height=window.innerHeight,o=-1e3,r=-1e3;const h=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window||navigator.maxTouchPoints>0;window.addEventListener("resize",()=>{i=s.width=window.innerWidth,e=s.height=window.innerHeight,j()}),h||(window.addEventListener("mousemove",l=>{o=l.clientX,r=l.clientY}),window.addEventListener("mouseleave",()=>{o=-1e3,r=-1e3})),new MutationObserver(()=>{c.baseColor=S()}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]});function $(l){const a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(l);return a?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null}function S(){return document.documentElement.getAttribute("data-theme")==="dark"?{...$("#FFFFFF"),a:.03}:{...$("#000000"),a:.07}}const c={size:40,speed:.18,baseColor:S(),hoverColor:{...$("#C2A365"),a:.65},rows:16,hoverRadius:90,transitionSpeed:.1,mobileGlowChance:3e-4,mobileGlowFadeInSpeed:.04,mobileGlowFadeOutSpeed:.015};let w=[];class k{constructor(a,d){this.x=a,this.y=d,this.size=c.size,this.speed=c.speed+(Math.random()-.5)*.2,this.hoverAmount=0,this.isGlowing=!1,this.glowPhase="idle"}isMouseNear(){const a=this.x+this.size/2,d=this.y+this.size/2;return Math.sqrt((o-a)**2+(r-d)**2)<c.hoverRadius}draw(){const a=c.baseColor,d=c.hoverColor,p=this.hoverAmount,T=Math.round(a.r+(d.r-a.r)*p),A=Math.round(a.g+(d.g-a.g)*p),D=Math.round(a.b+(d.b-a.b)*p),O=a.a+(d.a-a.a)*p;n.beginPath(),n.moveTo(this.x,this.y),n.lineTo(this.x+this.size,this.y+this.size/2),n.lineTo(this.x,this.y+this.size),n.closePath(),n.fillStyle=`rgba(${T}, ${A}, ${D}, ${O})`,n.fill()}update(){this.x+=this.speed,this.x>i+this.size&&(this.x=-this.size*2),h?(this.glowPhase==="idle"&&Math.random()<c.mobileGlowChance&&(this.glowPhase="fadeIn"),this.glowPhase==="fadeIn"?(this.hoverAmount=Math.min(1,this.hoverAmount+c.mobileGlowFadeInSpeed),this.hoverAmount>=1&&(this.glowPhase="fadeOut")):this.glowPhase==="fadeOut"&&(this.hoverAmount=Math.max(0,this.hoverAmount-c.mobileGlowFadeOutSpeed),this.hoverAmount<=0&&(this.glowPhase="idle"))):this.isMouseNear()?this.hoverAmount=Math.min(1,this.hoverAmount+c.transitionSpeed):this.hoverAmount=Math.max(0,this.hoverAmount-c.transitionSpeed)}}function j(){w=[];const l=e/c.rows;for(let a=0;a<c.rows;a++){const d=Math.ceil(i/(c.size*2));for(let p=0;p<d+2;p++){const T=p*(c.size*2)-c.size*3+(a%2===0?0:c.size),A=a*l+Math.random()*l/4;w.push(new k(T,A))}}}function M(){n.clearRect(0,0,i,e),w.forEach(l=>{l.update(),l.draw()}),requestAnimationFrame(M)}j(),M()}const I={title:"Introduction"},R=`<p>DARTS (Drone Autonomous Research and Technology for Swarms) is a cutting-edge initiative designed to democratize access to advanced swarm technology.</p>
<h3>The Mission</h3>
...
`,E=[{level:"3",content:"The Mission"},{level:"3",content:"Future Work"}],L=Object.freeze(Object.defineProperty({__proto__:null,attributes:I,html:R,toc:E},Symbol.toStringTag,{value:"Module"})),u={siteTitle:"DARTS Initiative",siteDescription:"DARTS is an open ecosystem for the research and development of autonomous, resilient, and scalable drone swarms.",logo:{src:"/images/logo_small.png",alt:"DARTS Initiative Logo"},blog:{title:"Latest Updates"},footer:{copyright:"© 2026 DARTS Initiative - Pablo Magariños Docampo",license:"Content distributed under open licenses | Committed to Open Source & Open Access",links:[{text:"GitHub",url:"https://github.com/DARTS-Initiative"},{text:"License",url:"#license"},{text:"Contribute",url:"#contribute"}]}};function m(t,s){document.title=t?`${t} | DARTS Initiative`:"DARTS Initiative";let n=document.querySelector('meta[name="description"]');n||(n=document.createElement("meta"),n.name="description",document.head.appendChild(n)),n.content=s||"Decentralized Autonomous Research & Technology System - Advancing open science and technology.";const i=(r,h)=>{let b=document.querySelector(`meta[property="${r}"]`)||document.querySelector(`meta[name="${r}"]`);b&&(b.content=h||"")},e=t?`${t} | DARTS Initiative`:"DARTS Initiative",o=s||"Decentralized Autonomous Research & Technology System - Advancing open science and technology.";i("og:title",e),i("og:description",o),i("twitter:title",e),i("twitter:description",o)}function g(t){t.innerHTML=`
        ...
        `}function y(t){return t?t.replace(/<img ([^>]*alt=")([^"|]*)\|([^"|]*)("[^>]*>)/g,(s,n,i,e,o)=>{const r=e.trim();return/^\d+(px|%|em|rem|vw|vh)$/.test(r)?`<img ${n}${i}" style="width: 100%; max-width: ${r};" ${o}`:s}):""}const P={News:{color:"#10b981",backgroundColor:"rgba(16, 185, 129, 0.1)",borderColor:"rgba(16, 185, 129, 0.2)"},Articles:{color:"#8b5cf6",backgroundColor:"rgba(139, 92, 246, 0.1)",borderColor:"rgba(139, 92, 246, 0.2)"},Others:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"},default:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"}},z=Object.assign({});let f=[];async function H(){try{const t=await fetch("/posts-index.json");if(!t.ok)throw new Error("Failed to load posts index");f=(await t.json()).posts||[],console.log("Posts index loaded:",f.length,"posts")}catch(t){console.error("Error loading posts index:",t),f=[]}}function F(){return f}function B(t){m("Blog","Read the latest news and updates from the DARTS Initiative.");const s=f.map(n=>{const i=n.slug;return`
    ...
    `}async function W(t,s){const n=`../../content/posts/${s}.md`,i=z[n];if(!i){g(t);return}try{const e=await i(),{attributes:o,html:r}=e;m(o.title,o.excerpt||o.description),t.innerHTML=`
            ...
            `}catch(e){console.error("Error loading post:",e),g(t)}}function x(t){const s=P[t]||P.default;return`
        color: ${s.color};
...
`,Z=[{level:"1",content:"DARTS Manifesto"}],tt=Object.freeze(Object.defineProperty({__proto__:null,attributes:J,html:Q,toc:Z},Symbol.toStringTag,{value:"Module"})),_=Object.assign({"../../content/pages/about-us.md":X,"../../content/pages/contributing.md":V,"../../content/pages/manifesto.md":tt});function et(){return _}function ot(t,s){const n=`../../content/pages/${s}.md`,i=_[n];if(!i){g(t);return}m(i.attributes.title,i.attributes.excerpt||i.attributes.description),t.innerHTML=`
        <div class="post-detail">
        ...
        `}const st=Object.assign({"../../content/intro.md":L});function nt(t){m(null,u.siteDescription);const s=et(),n=F(),i=Object.entries(s).map(([r,h])=>`
    ...
    <img src="${u.logo.src}" alt="${u.logo.alt}" class="logo">
        ...
        `}async function ct(t,s){const n=`../../content/projects/${s}.md`,i=it[n];if(!i){g(t);return}try{const e=await i(),{attributes:o,html:r}=e;m(o.title,o.excerpt||o.description),t.innerHTML=`
            <div class="post-detail">
            ...
            `}catch(e){console.error("Error loading project:",e),g(t)}}function lt(t){const s=document.getElementById(t);function n(e){document.querySelectorAll(".nav-link").forEach(o=>{o.classList.remove("active"),o.getAttribute("href")===e&&o.classList.add("active")}),(e===""||e==="#/")&&document.querySelector('.nav-link[href="#/"]')?.classList.add("active")}async function i(){const e=window.location.hash;if(window.scrollTo(0,0),n(e),e===""||e==="#/")nt(s);else if(e==="#/blog")B(s);else if(e==="#/projects")at(s);else if(e.startsWith("#/post/")){const o=e.replace("#/post/","");await W(s,o)}else if(e.startsWith("#/project/")){const o=e.replace("#/project/","");await ct(s,o)}else if(e.startsWith("#/page/")){const o=e.replace("#/page/","");ot(s,o)}else g(s)}i(),window.addEventListener("hashchange",i)}function dt(){const t=document.querySelector(".footer-content");if(!t)return;const s=u.footer.links.map(n=>`<a href="${n.url}" target="${n.url.startsWith("http")?"_blank":"_self"}">${n.text}</a>`).join("");t.innerHTML=`
        <p class="copyright">${u.footer.copyright}</p>
        <p class="license-info">${u.footer.license}</p>
        <div class="footer-links">
            ${s}
        </div>
        `}function ut(){const t=localStorage.getItem("theme"),s=window.matchMedia("(prefers-color-scheme: dark)").matches;t==="dark"||!t&&s?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.setAttribute("data-theme","light")}function ht(){const s=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";return document.documentElement.setAttribute("data-theme",s),localStorage.setItem("theme",s),s}function pt(){const t=document.getElementById("theme-toggle");t&&t.addEventListener("click",()=>{ht()})}ut();pt();C("background-canvas");await H();await rt();lt("app");dt();console.log("DARTS Initiative Website Initialized");
