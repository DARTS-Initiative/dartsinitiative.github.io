...
`,he=[],pe=Object.freeze(Object.defineProperty({__proto__:null,attributes:de,html:ue,toc:he},Symbol.toStringTag,{value:"Module"})),C=Object.assign({"../../content/pages/about-us.md":re,"../../content/pages/contributing.md":ce,"../../content/pages/roadmap.md":pe});function ge(){return C}function me(e,o){const t=`../../content/pages/${o}.md`,r=C[t];if(!r){y(e);return}S(r.attributes.title,r.attributes.excerpt||r.attributes.description),e.innerHTML=`
  ...
  `,document.body.appendChild(e),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("newsletter-visible")})});const o=()=>{$({dismissedAt:Date.now()}),j(e),document.removeEventListener("keydown",t)};e.querySelector(".newsletter-close").addEventListener("click",o),e.querySelector(".newsletter-form").addEventListener("submit",()=>{$({subscribedAt:Date.now()}),setTimeout(()=>j(e),300)}),e.querySelector(".newsletter-already").addEventListener("click",()=>{$({subscribedAt:Date.now()}),j(e)});const t=r=>{r.key==="Escape"&&o()};document.addEventListener("keydown",t)}function ye(){$({subscribedAt:Date.now()})}function Ae(){document.querySelector(".newsletter-banner")||F()}function Se(){we()&&setTimeout(F,5e3)}const $e=Object.assign({"../../content/intro.md":U});function Me(e){S(null,m.siteDescription);const o=ge(),t=Z(),r=Object.entries(o).map(([i,u])=>`
    ...
    <div class="logo-wrapper">
        ...
        `}async function je(e,o){const t=`../../content/projects/${o}.md`,r=Te[t];if(!r){y(e);return}try{const s=await r(),{attributes:n,html:a}=s;S(n.title,n.excerpt||n.description),e.innerHTML=`
            <div class="post-detail">
            ...
            `}catch(s){console.error("Error loading project:",s),y(e)}}function E(e){return/^[a-z0-9-]+$/i.test(e)}function Ee(e){const o=document.getElementById(e);function t(s){document.querySelectorAll(".nav-link").forEach(n=>{n.classList.remove("active"),n.getAttribute("href")===s&&n.classList.add("active")}),(s===""||s==="#/")&&document.querySelector('.nav-link[href="#/"]')?.classList.add("active")}async function r(){const s=window.location.hash;if(window.scrollTo(0,0),t(s),s===""||s==="#/")Me(o);else if(s==="#/blog")ee(o);else if(s==="#/projects")Ie(o);else if(s.startsWith("#/post/")){const n=s.replace("#/post/","");E(n)?await te(o,n):y(o)}else if(s.startsWith("#/project/")){const n=s.replace("#/project/","");E(n)?await je(o,n):y(o)}else if(s.startsWith("#/page/")){const n=s.replace("#/page/","");E(n)?me(o,n):y(o)}else y(o)}r(),window.addEventListener("hashchange",r)}function xe(){let e=document.querySelector("footer");e||(e=document.createElement("footer"),document.body.appendChild(e));const o=m.footer.links.map(t=>`<a href="${t.url}" target="${t.url.startsWith("http")?"_blank":"_self"}" ${t.url.startsWith("http")?'rel="noopener noreferrer"':""}>${t.text}</a>`).join("");e.innerHTML=`
