...
`,U=[],K=Object.freeze(Object.defineProperty({__proto__:null,attributes:W,html:G,toc:U},Symbol.toStringTag,{value:"Module"})),f={siteTitle:"DARTS",siteDescription:"Open initiative to research and share advances in <strong>AI that understands</strong>.",logo:{light:{svg:"/images/darts_logo.svg",png:"/images/darts_logo.png"},dark:{svg:"/images/darts_logo_black.svg",png:"/images/darts_logo_black.png"},alt:"DARTS Logo"},blog:{title:"Latest Updates"},newsletterUrl:"https://buttondown.com/api/emails/embed-subscribe/DARTS",footer:{copyright:"© 2026 DARTS Initiative",license:"Content licensed under CC BY 4.0",links:[{text:"GitHub",url:"https://github.com/DARTS-Initiative"},{text:"License",url:"https://creativecommons.org/licenses/by/4.0/"},{text:"Contact",url:"mailto:contact@dartsinitiative.com"}]}};function k(e,n){document.title=e?`${e} | DARTS`:"DARTS";let t=document.querySelector('meta[name="description"]');t||(t=document.createElement("meta"),t.name="description",document.head.appendChild(t)),t.content=n||"Open initiative to research and share advances in AI that understands";const r=(l,i)=>{let d=document.querySelector(`meta[property="${l}"]`)||document.querySelector(`meta[name="${l}"]`);d&&(d.content=i||"")},s=e?`${e} | DARTS`:"DARTS",o=n||"Open initiative to research and share advances in AI that understands.";r("og:title",s),r("og:description",o),r("twitter:title",s),r("twitter:description",o)}function S(e){e.innerHTML=`
        ...
        `}function M(e){return e?e.replace(/<img ([^>]*alt=")([^"|]*)\|([^"|]*)("[^>]*>)/g,(n,t,r,s,o)=>{const l=s.trim();return/^\d+(px|%|em|rem|vw|vh)$/.test(l)?`<img ${t}${r}" style="width: 100%; max-width: ${l};"${o.slice(1)}`:n}):""}const V="modulepreload",J=function(e){return"/"+e},R={},Q=function(n,t,r){let s=Promise.resolve();if(t&&t.length>0){let d=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),i=l?.nonce||l?.getAttribute("nonce");s=d(t.map(u=>{if(u=J(u),u in R)return;R[u]=!0;const h=u.endsWith(".css"),b=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${b}`))return;const c=document.createElement("link");if(c.rel=h?"stylesheet":V,h||(c.as="script"),c.crossOrigin="",c.href=u,i&&c.setAttribute("nonce",i),document.head.appendChild(c),h)return new Promise((y,g)=>{c.addEventListener("load",y),c.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function o(l){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=l,window.dispatchEvent(i),!i.defaultPrevented)throw l}return s.then(l=>{for(const i of l||[])i.status==="rejected"&&o(i.reason);return n().catch(o)})},C={News:{color:"#10b981",backgroundColor:"rgba(16, 185, 129, 0.1)",borderColor:"rgba(16, 185, 129, 0.2)"},Articles:{color:"#8b5cf6",backgroundColor:"rgba(139, 92, 246, 0.1)",borderColor:"rgba(139, 92, 246, 0.2)"},Others:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"},default:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"}},Z=Object.assign({"../../content/posts/welcome-to-darts.md":()=>Q(()=>import("./welcome-to-darts-VqW7cEBo.js"),[])});let T=[];async function ee(){try{const e=await fetch("/posts-index.json");if(!e.ok)throw new Error("Failed to load posts index");T=(await e.json()).posts||[]}catch(e){console.error("Error loading posts index:",e),T=[]}}function te(){return T}function ne(e){k("Content","Read the latest news and updates from the DARTS Initiative.");const n=T.map(t=>{const r=t.slug;return`
    ...
    `}async function oe(e,n){const t=`../../content/posts/${n}.md`,r=Z[t];if(!r){S(e);return}try{const s=await r(),{attributes:o,html:l}=s;k(o.title,o.excerpt||o.description),e.innerHTML=`
            ...
            `}catch(s){console.error("Error loading post:",s),S(e)}}function D(e){const n=C[e]||C.default;return`
        color: ${n.color};
...
`,de=[{level:"2",content:"Blog content"},{level:"2",content:"Projects"},{level:"2",content:"Development and outreach"}],ue=Object.freeze(Object.defineProperty({__proto__:null,attributes:le,html:ce,toc:de},Symbol.toStringTag,{value:"Module"})),he={title:"What to Expect"},pe=`<p>DARTS is built around open work. Everything developed here is shared publicly
...
`,me=[{level:"2",content:"Projects"},{level:"2",content:"Content"}],ge=Object.freeze(Object.defineProperty({__proto__:null,attributes:he,html:pe,toc:me},Symbol.toStringTag,{value:"Module"})),F=Object.assign({"../../content/pages/about-us.md":ae,"../../content/pages/contributing.md":ue,"../../content/pages/what-to-expect.md":ge});function fe(){return F}function be(e,n){const t=`../../content/pages/${n}.md`,r=F[t];if(!r){S(e);return}k(r.attributes.title,r.attributes.excerpt||r.attributes.description),e.innerHTML=`
        <div class="post-detail">
  ...
  `,document.body.appendChild(e),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("thankyou-visible")})});const n=()=>{e.classList.remove("thankyou-visible"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),document.removeEventListener("keydown",t)};e.querySelector(".newsletter-close").addEventListener("click",n),e.addEventListener("click",r=>{r.target===e&&n()});const t=r=>{r.key==="Escape"&&n()};document.addEventListener("keydown",t)}function Ae(){E({subscribedAt:Date.now()}),H()}function $e(){document.querySelector(".newsletter-banner")||q()}function ke(){Se()&&setTimeout(q,5e3)}const Ee=Object.assign({"../../content/intro.md":K});function Te(e){k(null,f.siteDescription);const n=fe(),t=te(),r=Object.entries(n).map(([i,d])=>`
    ...
    <div class="logo-wrapper">
        ...
        `,e.querySelectorAll(".logo-light").forEach(i=>{i.addEventListener("error",function(){this.src=f.logo.light.png},{once:!0})}),e.querySelectorAll(".logo-dark").forEach(i=>{i.addEventListener("error",function(){this.src=f.logo.dark.png},{once:!0})});{const i=e.querySelectorAll(".logo");let d=1,u=0,h=null;const b=()=>{if(u=u*.872+(1-d)*.08,d+=u,Math.abs(1-d)<5e-4&&Math.abs(u)<5e-4){d=1,u=0,i.forEach(A=>{A.style.transform=""}),h=null;return}i.forEach(A=>{A.style.transform=`scale(${d})`}),h=requestAnimationFrame(b)};let c=0,y=!1;i.forEach(g=>{g.style.cursor="pointer",g.style.willChange="transform",g.addEventListener("click",()=>{if(!y&&(d=Math.max(.3,d-.22),u=0,h&&cancelAnimationFrame(h),h=requestAnimationFrame(b),c++,c===10)){y=!0,h&&cancelAnimationFrame(h);const v=e.querySelector(".logo-wrapper");v&&(v.dispatchEvent(new Event("escaped")),v.style.transition="transform 0.6s cubic-bezier(0.4, 0, 1, 1), opacity 0.6s ease",v.style.transform="translateX(150%)",v.style.opacity="0")}})})}if(!window.matchMedia("(prefers-reduced-motion: reduce)").matches){const i=e.querySelector(".logo-wrapper");if(i){const d=i.getBoundingClientRect().top;let u=!1;i.addEventListener("escaped",()=>{u=!0});const h=()=>{if(!i.isConnected){window.removeEventListener("scroll",h);return}if(u)return;const b=i.getBoundingClientRect(),c=b.height;if(!c)return;const y=d+c,g=Math.max(0,Math.min(1,(d-b.top)/y)),v=2*g*g*g;i.style.transform=v>0?`translateX(${v*130}%)`:"",i.style.opacity=v>0?1-g:""};window.addEventListener("scroll",h,{passive:!0})}}const l=e.querySelector(".subscribe-form");l&&l.addEventListener("submit",()=>Ae())}const Me=Object.assign({});let _=[];async function je(){try{const e=await fetch("/projects-index.json");if(!e.ok)throw new Error("Failed to load projects index");_=(await e.json()).projects||[]}catch(e){console.error("Error loading projects index:",e),_=[]}}function xe(e){k("Projects","Discover the innovative projects developed by the DARTS Initiative.");const n=_.map(t=>{const r=t.slug;return`
    ...
    `,e.querySelector(".footer-subscribe").addEventListener("click",t=>{t.preventDefault(),$e()})}function De(){const e=localStorage.getItem("theme"),n=window.matchMedia("(prefers-color-scheme: dark)").matches;e==="dark"||!e&&n?document.documentElement.setAttribute("data-theme","dark"):document.documentElement.setAttribute("data-theme","light")}function Ie(){const n=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";return document.documentElement.setAttribute("data-theme",n),localStorage.setItem("theme",n),n}function Re(){const e=document.getElementById("theme-toggle");e&&e.addEventListener("click",()=>{Ie()})}De();Re();X("background-canvas");try{await ee()}catch(e){console.error("Failed to load posts:",e)}try{await je()}catch(e){console.error("Failed to load projects:",e)}Le("app");_e();ke();
