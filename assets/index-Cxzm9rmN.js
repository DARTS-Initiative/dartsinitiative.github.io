(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();function N(e){const o=document.getElementById(e);if(!o)return;const t=o.getContext("2d");let r=o.width=window.innerWidth,s=o.height=window.innerHeight,n=-1e3,a=-1e3;const i=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||"ontouchstart"in window||navigator.maxTouchPoints>0;window.addEventListener("resize",()=>{r=o.width=window.innerWidth,s=o.height=window.innerHeight,D()}),i||(window.addEventListener("mousemove",f=>{n=f.clientX,a=f.clientY}),window.addEventListener("mouseleave",()=>{n=-1e3,a=-1e3})),new MutationObserver(()=>{d.baseColor=g()}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]});function c(f){const l=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(f);return l?{r:parseInt(l[1],16),g:parseInt(l[2],16),b:parseInt(l[3],16)}:null}function g(){return document.documentElement.getAttribute("data-theme")==="dark"?{...c("#FFFFFF"),a:.022}:{...c("#000000"),a:.1}}const d={baseColor:g(),hoverColor:{...c("#C2A365"),a:.55},hoverRadius:160,transitionSpeed:.06,mobileGlowChance:2e-4,mobileGlowFadeInSpeed:.025,mobileGlowFadeOutSpeed:.01,layers:[{count:.3,sizeRange:[12,20],speedFactor:.4,opacityMult:.5},{count:.4,sizeRange:[22,34],speedFactor:.7,opacityMult:.75},{count:.3,sizeRange:[36,50],speedFactor:1,opacityMult:1}],totalCount:i?90:300};let p=[],y=0;class w{constructor(l,b,h){this.originX=l,this.originY=b,this.x=l,this.y=b,this.layer=h,this.size=h.sizeRange[0]+Math.random()*(h.sizeRange[1]-h.sizeRange[0]),this.rotation=Math.random()*Math.PI*2,this.rotationSpeed=(Math.random()-.5)*.002*h.speedFactor,this.hoverAmount=0,this.glowPhase="idle",this.driftPhaseX=Math.random()*Math.PI*2,this.driftPhaseY=Math.random()*Math.PI*2,this.driftAmplitudeX=12+Math.random()*25*h.speedFactor,this.driftAmplitudeY=10+Math.random()*20*h.speedFactor,this.driftSpeedX=(.001+Math.random()*.0015)*h.speedFactor,this.driftSpeedY=(8e-4+Math.random()*.0012)*h.speedFactor;const A=Math.random()*Math.PI*2;this.linearDriftX=Math.cos(A)*.12*h.speedFactor,this.linearDriftY=Math.sin(A)*.12*h.speedFactor}isMouseNear(){return Math.sqrt((n-this.x)**2+(a-this.y)**2)<d.hoverRadius}draw(){const l=d.baseColor,b=d.hoverColor,h=this.hoverAmount,A=this.layer.opacityMult,q=Math.round(l.r+(b.r-l.r)*h),B=Math.round(l.g+(b.g-l.g)*h),H=Math.round(l.b+(b.b-l.b)*h),Y=(l.a+(b.a-l.a)*h)*A;t.save(),t.translate(this.x,this.y),t.rotate(this.rotation);const k=this.size,I=k*.866;t.beginPath(),t.moveTo(0,-I/2),t.lineTo(-k/2,I/2),t.lineTo(k/2,I/2),t.closePath(),t.fillStyle=`rgba(${q}, ${B}, ${H}, ${Y})`,t.fill(),t.restore()}update(){this.x=this.originX+Math.sin(y*this.driftSpeedX+this.driftPhaseX)*this.driftAmplitudeX,this.y=this.originY+Math.sin(y*this.driftSpeedY+this.driftPhaseY)*this.driftAmplitudeY,this.originX+=this.linearDriftX,this.originY+=this.linearDriftY;const l=this.size*2;this.originX>r+l&&(this.originX=-l),this.originX<-l&&(this.originX=r+l),this.originY>s+l&&(this.originY=-l),this.originY<-l&&(this.originY=s+l),this.rotation+=this.rotationSpeed,i?(this.glowPhase==="idle"&&Math.random()<d.mobileGlowChance&&(this.glowPhase="fadeIn"),this.glowPhase==="fadeIn"?(this.hoverAmount=Math.min(1,this.hoverAmount+d.mobileGlowFadeInSpeed),this.hoverAmount>=1&&(this.glowPhase="fadeOut")):this.glowPhase==="fadeOut"&&(this.hoverAmount=Math.max(0,this.hoverAmount-d.mobileGlowFadeOutSpeed),this.hoverAmount<=0&&(this.glowPhase="idle"))):this.isMouseNear()?this.hoverAmount=Math.min(1,this.hoverAmount+d.transitionSpeed):this.hoverAmount=Math.max(0,this.hoverAmount-d.transitionSpeed)}}function D(){p=[];for(const f of d.layers){const l=Math.round(d.totalCount*f.count);for(let b=0;b<l;b++){const h=Math.random()*(r+100)-50,A=Math.random()*(s+100)-50;p.push(new w(h,A,f))}}}function _(){y++,t.clearRect(0,0,r,s),p.forEach(f=>{f.update(),f.draw()}),requestAnimationFrame(_)}D(),_()}const z={title:"Introduction"},X=`<p>Current generative AI achieves incredible things, but it learns passively: consuming massive amounts of data without grounding its knowledge in reality.</p>
...
`,W=[],U=Object.freeze(Object.defineProperty({__proto__:null,attributes:z,html:X,toc:W},Symbol.toStringTag,{value:"Module"})),m={siteTitle:"DARTS",siteDescription:"Open ecosystem to research and share advances in <strong>AI that understands</strong>.",logo:{light:{svg:"/images/darts_logo.svg",png:"/images/darts_logo.png"},dark:{svg:"/images/darts_logo_black.svg",png:"/images/darts_logo_black.png"},alt:"DARTS Logo"},blog:{title:"Latest Updates"},newsletterUrl:"https://buttondown.com/api/emails/embed-subscribe/DARTS",footer:{copyright:"© 2026 DARTS Initiative - Pablo Magariños Docampo",license:"Content distributed under open licenses | Committed to Open Source & Open Access",links:[{text:"GitHub",url:"https://github.com/DARTS-Initiative"},{text:"License",url:"https://creativecommons.org/licenses/by/4.0/"},{text:"Contribute",url:"#/page/contributing"}]}};function S(e,o){document.title=e?`${e} | DARTS`:"DARTS";let t=document.querySelector('meta[name="description"]');t||(t=document.createElement("meta"),t.name="description",document.head.appendChild(t)),t.content=o||"Decentralized Autonomous Research & Technology System - Advancing open science and technology.";const r=(a,i)=>{let u=document.querySelector(`meta[property="${a}"]`)||document.querySelector(`meta[name="${a}"]`);u&&(u.content=i||"")},s=e?`${e} | DARTS`:"DARTS",n=o||"Decentralized Autonomous Research & Technology System - Advancing open science and technology.";r("og:title",s),r("og:description",n),r("twitter:title",s),r("twitter:description",n)}function v(e){e.innerHTML=`
        ...
        `}function M(e){return e?e.replace(/<img ([^>]*alt=")([^"|]*)\|([^"|]*)("[^>]*>)/g,(o,t,r,s,n)=>{const a=s.trim();return/^\d+(px|%|em|rem|vw|vh)$/.test(a)?`<img ${t}${r}" style="width: 100%; max-width: ${a};" ${n}`:o}):""}const G="modulepreload",V=function(e){return"/"+e},R={},K=function(o,t,r){let s=Promise.resolve();if(t&&t.length>0){let u=function(c){return Promise.all(c.map(g=>Promise.resolve(g).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),i=a?.nonce||a?.getAttribute("nonce");s=u(t.map(c=>{if(c=V(c),c in R)return;R[c]=!0;const g=c.endsWith(".css"),d=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${d}`))return;const p=document.createElement("link");if(p.rel=g?"stylesheet":G,g||(p.as="script"),p.crossOrigin="",p.href=c,i&&p.setAttribute("nonce",i),document.head.appendChild(p),g)return new Promise((y,w)=>{p.addEventListener("load",y),p.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(a){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=a,window.dispatchEvent(i),!i.defaultPrevented)throw a}return s.then(a=>{for(const i of a||[])i.status==="rejected"&&n(i.reason);return o().catch(n)})},L={News:{color:"#10b981",backgroundColor:"rgba(16, 185, 129, 0.1)",borderColor:"rgba(16, 185, 129, 0.2)"},Articles:{color:"#8b5cf6",backgroundColor:"rgba(139, 92, 246, 0.1)",borderColor:"rgba(139, 92, 246, 0.2)"},Others:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"},default:{color:"#6b7280",backgroundColor:"rgba(107, 114, 128, 0.1)",borderColor:"rgba(107, 114, 128, 0.2)"}},J=Object.assign({"../../content/posts/demo-post.md":()=>K(()=>import("./demo-post-VqW7cEBo.js"),[])});let T=[];async function Q(){try{const e=await fetch("/posts-index.json");if(!e.ok)throw new Error("Failed to load posts index");T=(await e.json()).posts||[]}catch(e){console.error("Error loading posts index:",e),T=[]}}function Z(){return T}function ee(e){S("Blog","Read the latest news and updates from the DARTS Initiative.");const o=T.map(t=>{const r=t.slug;return`
    ...
    `}async function te(e,o){const t=`../../content/posts/${o}.md`,r=J[t];if(!r){v(e);return}try{const s=await r(),{attributes:n,html:a}=s;S(n.title,n.excerpt||n.description),e.innerHTML=`
...
`,he=[],pe=Object.freeze(Object.defineProperty({__proto__:null,attributes:de,html:ue,toc:he},Symbol.toStringTag,{value:"Module"})),O=Object.assign({"../../content/pages/about-us.md":re,"../../content/pages/contributing.md":ce,"../../content/pages/roadmap.md":pe});function ge(){return O}function me(e,o){const t=`../../content/pages/${o}.md`,r=O[t];if(!r){v(e);return}S(r.attributes.title,r.attributes.excerpt||r.attributes.description),e.innerHTML=`
  ...
  `,document.body.appendChild(e),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("newsletter-visible")})});const o=()=>{$({dismissedAt:Date.now()}),j(e),document.removeEventListener("keydown",t)};e.querySelector(".newsletter-close").addEventListener("click",o),e.querySelector(".newsletter-form").addEventListener("submit",()=>{$({subscribedAt:Date.now()}),setTimeout(()=>j(e),300)}),e.querySelector(".newsletter-already").addEventListener("click",()=>{$({subscribedAt:Date.now()}),j(e)});const t=r=>{r.key==="Escape"&&o()};document.addEventListener("keydown",t)}function ye(){$({subscribedAt:Date.now()})}function Ae(){document.querySelector(".newsletter-banner")||F()}function Se(){we()&&setTimeout(F,5e3)}const $e=Object.assign({"../../content/intro.md":U});function Te(e){S(null,m.siteDescription);const o=ge(),t=Z(),r=Object.entries(o).map(([i,u])=>`
    ...
    `).join(""),s=t.slice(0,2).map(i=>{const u=i.slug;return`
        ...
        `}).join(""),n=M($e["../../content/intro.md"]?.html);e.innerHTML=`
    <img 
        ...
        `,e.querySelectorAll(".logo-light").forEach(i=>{i.addEventListener("error",function(){this.src=m.logo.light.png},{once:!0})}),e.querySelectorAll(".logo-dark").forEach(i=>{i.addEventListener("error",function(){this.src=m.logo.dark.png},{once:!0})});{const i=e.querySelectorAll(".logo");let u=1,c=0,g=null;const d=()=>{if(c=c*.208+(1-u)*.058,u+=c,Math.abs(1-u)<5e-4&&Math.abs(c)<5e-4){u=1,c=0,i.forEach(w=>{w.style.transform=""}),g=null;return}i.forEach(w=>{w.style.transform=`scale(${u})`}),g=requestAnimationFrame(d)};i.forEach(p=>{p.style.cursor="pointer",p.style.willChange="transform",p.addEventListener("click",()=>{u=Math.max(.3,u-.22),c=0,g&&cancelAnimationFrame(g),g=requestAnimationFrame(d)})})}const a=e.querySelector(".subscribe-form");a&&a.addEventListener("submit",()=>ye())}const Me=Object.assign({});let x=[];async function ke(){try{const e=await fetch("/projects-index.json");if(!e.ok)throw new Error("Failed to load projects index");x=(await e.json()).projects||[]}catch(e){console.error("Error loading projects index:",e),x=[]}}function Ie(e){S("Projects","Discover the innovative projects developed by the DARTS Initiative.");const o=x.map(t=>{const r=t.slug;return`
        ...
        `}async function je(e,o){const t=`../../content/projects/${o}.md`,r=Me[t];if(!r){v(e);return}try{const s=await r(),{attributes:n,html:a}=s;S(n.title,n.excerpt||n.description),e.innerHTML=`
            <div class="post-detail">
            ...
            `}catch(s){console.error("Error loading project:",s),v(e)}}function E(e){return/^[a-z0-9-]+$/i.test(e)}function Ee(e){const o=document.getElementById(e);function t(s){document.querySelectorAll(".nav-link").forEach(n=>{n.classList.remove("active"),n.getAttribute("href")===s&&n.classList.add("active")}),(s===""||s==="#/")&&document.querySelector('.nav-link[href="#/"]')?.classList.add("active")}async function r(){const s=window.location.hash;if(window.scrollTo(0,0),t(s),s===""||s==="#/")Te(o);else if(s==="#/blog")ee(o);else if(s==="#/projects")Ie(o);else if(s.startsWith("#/post/")){const n=s.replace("#/post/","");E(n)?await te(o,n):v(o)}else if(s.startsWith("#/project/")){const n=s.replace("#/project/","");E(n)?await je(o,n):v(o)}else if(s.startsWith("#/page/")){const n=s.replace("#/page/","");E(n)?me(o,n):v(o)}else v(o)}r(),window.addEventListener("hashchange",r)}function xe(){let e=document.querySelector("footer");e||(e=document.createElement("footer"),document.body.appendChild(e));const o=m.footer.links.map(t=>`<a href="${t.url}" target="${t.url.startsWith("http")?"_blank":"_self"}" ${t.url.startsWith("http")?'rel="noopener noreferrer"':""}>${t.text}</a>`).join("");e.innerHTML=`
